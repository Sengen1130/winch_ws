...
(cl:defmethod cl:initialize-instance :after ((m <adder>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'adder)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name system_control-msg:<adder> is deprecated: use system_control-msg:adder instead.")))

(cl:ensure-generic-function 'angle1-val :lambda-list '(m))
(cl:defmethod angle1-val ((m <adder>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader system_control-msg:angle1-val is deprecated.  Use system_control-msg:angle1 instead.")
  (angle1 m))

(cl:ensure-generic-function 'angle2-val :lambda-list '(m))
(cl:defmethod angle2-val ((m <adder>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader system_control-msg:angle2-val is deprecated.  Use system_control-msg:angle2 instead.")
  (angle2 m))
