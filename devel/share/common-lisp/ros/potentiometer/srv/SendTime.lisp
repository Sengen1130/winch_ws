...
(cl:defmethod cl:initialize-instance :after ((m <SendTime-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SendTime-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name potentiometer-srv:<SendTime-request> is deprecated: use potentiometer-srv:SendTime-request instead.")))

(cl:ensure-generic-function 'second-val :lambda-list '(m))
(cl:defmethod second-val ((m <SendTime-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader potentiometer-srv:second-val is deprecated.  Use potentiometer-srv:second instead.")
  (second m))

(cl:ensure-generic-function 'nsecond-val :lambda-list '(m))
(cl:defmethod nsecond-val ((m <SendTime-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader potentiometer-srv:nsecond-val is deprecated.  Use potentiometer-srv:nsecond instead.")
  (nsecond m))
...
(cl:defmethod cl:initialize-instance :after ((m <SendTime-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SendTime-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name potentiometer-srv:<SendTime-response> is deprecated: use potentiometer-srv:SendTime-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <SendTime-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader potentiometer-srv:success-val is deprecated.  Use potentiometer-srv:success instead.")
  (success m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SendTime-response>)))
  ...
  "potentiometer/SendTimeResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SendTime-response)))
  "Returns string type for a service object of type 'SendTime-response"
  "potentiometer/SendTimeResponse")
