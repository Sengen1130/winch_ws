...
set(MSG_I_FLAGS "-Isensor:/home/pi/winch_ws/src/sensor/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/pi/winch_ws/src/sensor/msg/adder.msg" NAME_WE)
add_custom_target(_sensor_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "sensor" "/home/pi/winch_ws/src/sensor/msg/adder.msg" ""
)
...
_generate_msg_cpp(sensor
  "/home/pi/winch_ws/src/sensor/msg/adder.msg"
  "${MSG_I_FLAGS}"
  ""
